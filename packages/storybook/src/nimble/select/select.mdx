...
<StoryApi>
<h3 id={sections.api.id}>{sections.api.title}</h3>

<Controls of={selectStories.select} />
<ComponentApisLink />

<h3 id={sections.listOption.id}>{sections.listOption.title}</h3>
...
<h3 id={sections.listOptionGroup.id}>{sections.listOptionGroup.title}</h3>
...
<h3 id={sections.placeholder.id}>{sections.placeholder.title}</h3>
...
<h3 id={sections.dynamicOptions.id}>{sections.dynamicOptions.title}</h3>
