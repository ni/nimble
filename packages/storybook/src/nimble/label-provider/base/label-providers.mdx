...
For Angular clients, see [Localization section of the nimble-angular readme](https://github.com/ni/nimble/blob/main/packages/angular-workspace/nimble-angular/README.md#localization-optional) for specific usage guidance with Angular.

### Blazor

See the [Localization section of the blazor-workspace readme](https://github.com/ni/nimble/tree/main/packages/blazor-workspace#localization-optional) for specific usage guidance for the label providers with Blazor.
