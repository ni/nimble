...
provide ways to provide a menu associated with a row in the table. However, they
...
When using the <Tag name={tableColumnMenuButtonTag}/>, the currently selected
value should also exist as an item in the menu and be marked as selected with
the <Tag name={iconCheckTag}/>.
