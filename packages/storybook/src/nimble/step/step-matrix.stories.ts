...
import { selectedStates, severityStates, stepContentStates, stepContentStateShort, type SelectedState, type SeverityStates, type StepContentStates } from '../stepper/types';
