...
const metadata: Meta = {
    ...
    parameters: {
        docs: {
            description: {
                component:
                    'The `nimble-mapping-text` element defines a mapping from a data value to display text. It is meant to be used as content of the `nimble-table-column-icon` column type element.'
            }
        }
    }
};
