...
<Canvas of={chatStories.chatWindow} />
...
Use the <Tag name={chatInputToolbarTag} /> element to collect user input for a chat conversation.

<Canvas of={chatStories.chatInputToolbar} />
<Controls of={chatStories.chatInputToolbar} />
