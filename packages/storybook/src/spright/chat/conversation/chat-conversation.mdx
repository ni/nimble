...
Use the <Tag name={chatMessageWelcomeTag} /> element to display welcome content in the chat window.

##### Welcome message content

<Canvas of={conversationStories.chatMessageWelcome} />
<Controls of={conversationStories.chatMessageWelcome} />
