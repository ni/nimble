...
// [Nimble] Removed RouterLink
const ROUTER_DIRECTIVES = [RouterLinkActive, RouterOutlet];

// [Nimble] Skipping navigation-based routing tests, because I cannot get ɵprovideFakePlatformNavigation
//  to work. It results in an error about FakeNavigation not being provided, but ɵprovideFakePlatformNavigation
//  looks like it is providing it: https://github.com/angular/angular/blob/182138e74bd39c7b4fd152368fa6e3087b20cc86/packages/common/testing/src/navigation/provide_fake_platform_navigation.ts#L30
//for (const browserAPI of ['navigation', 'history'] as const) {
for (const browserAPI of ['history'] as const) {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        providers: [
          ...
          // [Nimble] Not testing navigation-based routing
    ...
    describe('router links', () => {
      ...
      it('should support using links on non-a tags', fakeAsync(
        inject([Router], (router: Router) => {
          ...
          // [Nimble] our RouterLink fork treats everything like a native anchor, so does not set tabindex
      ...
      */
      ...
      it('can use `relativeTo` `route.parent` in `routerLink` to close secondary outlet', fakeAsync(() => {
        ...
        class RelativeLinkCmp {
          // [Nimble] replace RouterLink with TestRouterLinkDirective
          @ViewChildren(TestRouterLinkDirective) links!: QueryList<TestRouterLinkDirective>;
...
@NgModule({
  // [Nimble] Add TestRouterLinkModule to imports
  imports: [CommonModule, ...ROUTER_DIRECTIVES, TestRouterLinkModule],
