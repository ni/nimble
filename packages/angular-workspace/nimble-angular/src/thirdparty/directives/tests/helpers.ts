/**
 * [Nimble]
 * Copied from https://github.com/angular/angular/blob/20.3.15/packages/router/test/helpers.ts
 * with the following modifications:
 * - excluded most of the code
 */
...
// [Nimble] Exclude everything we don't need
/*
