...
The `directives` folder corresponds to the [`packages/forms/src/directives` folder](https://github.com/angular/angular/tree/19.2.15/packages/forms/src/directives) of the Angular repo. **When updating the version of Angular** used by the `nimble-angular` package:
