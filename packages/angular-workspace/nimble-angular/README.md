...
The steps to use components from Nimble Angular are similar to using components from any other Angular library. You can see the [Example Client App](../example-client-app) project for an example.
