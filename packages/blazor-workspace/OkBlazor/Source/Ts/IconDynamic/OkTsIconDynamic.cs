...
/// </summary>
public static class OkTsIconDynamic
{
    private const string RegisterIconDynamicMethodName = "OkBlazor.TsIconDynamic.registerIconDynamic";
    ...
    /// <param name="tagName">The dynamic icon tag name (for example, "ok-ts-icon-dynamic-awesome").</param>
