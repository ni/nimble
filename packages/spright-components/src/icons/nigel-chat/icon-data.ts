...
<svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 16 16">
  <defs>
    ...
    <linearGradient id="linear-gradient2" x1="11.84" y1="6.19" x2="4.84" y2="13.18" gradientTransform="translate(0 18) scale(1 -1)" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#00ad7c"/>
      <stop offset="1" stop-color="#32eb96"/>
    </linearGradient>
    <linearGradient id="linear-gradient3" x1="10.25" y1="-658.82" x2="6.95" y2="-662.11" gradientTransform="translate(0 668)" xlink:href="#linear-gradient2"/>
  </defs>
