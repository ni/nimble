...
const apacheArrowBasePath = path.dirname(require.resolve('apache-arrow'));
const apacheArrowSrc = [
    { src: '**' }
];
...
prepareDestinationDirectory('apache-arrow');
copyFiles(apacheArrowSrc, apacheArrowBasePath, 'apache-arrow');
