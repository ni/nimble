...
<!-- Link using JS so Storybook's router doesn't intercept it -->
See the <a href="javascript:top.window.location='example-client-app'">example Angular app</a> using the components!
