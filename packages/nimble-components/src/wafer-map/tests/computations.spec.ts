...
import { Margin, Quadrant } from '../types';
...
describe('Computations module', () => {
    ...
    describe('with 100 square canvas', () => {
        ...
        it('should have 60 square container', () => {
            expect(computationsModule.containerDimensions).toEqual({ width: 60, height: 60 });
        });

        it('should have 10:8.571428571428571 die', () => {
            expect(computationsModule.dieDimensions).toEqual({ width: 10, height: 8.571428571428571 });
        });
    ...
    describe('with 180 square canvas', () => {
        ...
        it('should have 110 square container', () => {
            expect(computationsModule.containerDimensions).toEqual({ width: 110, height: 110 });
        });

        it('should have 18.333333333333332:15.714285714285714 die', () => {
            expect(computationsModule.dieDimensions).toEqual({ width: 18.333333333333332, height: 15.714285714285714 });
        });

        it('should have 82.5 radius', () => {
            expect(computationsModule.radius).toEqual(82.5);
        });

        it('should have adjusted margin', () => {
            expect(computationsModule.margin).toEqual({ top: 35, right: 35, bottom: 35, left: 35 });
        });
    });
    ...
    describe('with top left origin quadrant', () => {
        ...
        it('should have horizontal domain equal to the lowest column index, '
        ...
        it('should have vertical domain equal to the lowest row index, '
    ...
    describe('with top right origin quadrant', () => {
        ...
        it('should have horizontal domain equal to the highest column index, '
            + 'but one position lower than the lowest column index ', () => {
            expect(computationsModule.horizontalScale.domain()).toEqual([1, 6]);
        });
    ...
    describe('with bottom left origin quadrant', () => {
        ...
        it('should have vertical domain equal to the highest row index, '
        + 'but one position lower than the lowest row index ', () => {
            expect(computationsModule.verticalScale.domain()).toEqual([0, 6]);
        });
