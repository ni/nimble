...
const valueToString = (value:number) => {return value %1 ? value.toFixed(2):Math.trunc(value).toString()};

export const  generateWaferData = (numDies:number, valueGenerator?: IValueGenerator)=>{
