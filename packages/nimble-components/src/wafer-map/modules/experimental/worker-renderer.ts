...
export class WorkerRenderer {
    ...
    public renderHover(): void {
        const hoverWidth = this.wafermap.experimentalDataManager.dieDimensions.width * this.wafermap.transform.k;
        this.wafermap.hoverWidth = isNaN(hoverWidth) ? 0 : hoverWidth;
        const hoverHeight = this.wafermap.experimentalDataManager.dieDimensions.height * this.wafermap.transform.k;
