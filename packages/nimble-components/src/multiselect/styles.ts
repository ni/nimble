...
export const styles = css`
    ...
    /* Override list-option's hidden start slot to show check icons */
    ::slotted([role='option']) [part='start'] {
        display: flex;
        align-items: center;
    ...
    /* Multiselect-specific styles for check markers */
    /* Note: Check icons are injected dynamically via selectedOptionsChanged */
`.withBehaviors(
    appearanceBehavior(
