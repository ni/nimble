...
const baseName = 'nimble-anchored-region';
export const anchoredRegionTag = `nimble-${baseName}`;
declare global {
...
DesignSystem.getOrCreate().withPrefix('nimble').register(nimbleAnchoredRegion());
