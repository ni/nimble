...
-   Focusing via tab should show the URL preview at the bottom of the browser window
    - Note: [macOS Firefox doesn't allow focusing links via tab by default](https://stackoverflow.com/questions/11704828/how-to-allow-keyboard-focus-of-links-in-firefox)
