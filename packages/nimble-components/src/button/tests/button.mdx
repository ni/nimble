...
Appearance-Variant buttons are mainly used when a button needs to distinguish its visibly for one of the following reasons:
...
There are currently two appearance-variants available: primary and accent.
