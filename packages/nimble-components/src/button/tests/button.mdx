...
import {
    ...
    Dont,
    Frame
} from '../../../.storybook/blocks/StoryLayout';
import { NimbleButton } from './button.react';
import { NimbleIconKey } from '../../icon-base/tests/icons.react';
...
<Frame>
    <Container config="375px 1fr">
        ...
        <Column size="medium">
            ...
            <Dont>
                When using an outline button, do not use it with a block button
                to create hierarchy.
            </Dont>
            <Dont>
                When using a block button, do not use it with an outline button
                to create hierarchy.
            </Dont>
        </Column>
    </Container>
...
<Frame>
    <Container config="375px 1fr">
        <Column stylingClass="controls">
            <NimbleButton appearance="ghost">Ghost Button</NimbleButton>
            <NimbleButton appearance="ghost">Ghost Button</NimbleButton>
            <NimbleButton appearance="block" appearance-variant="accent">
                {`Accent Button`}
            </NimbleButton>
        </Column>
        <Column size="medium">
