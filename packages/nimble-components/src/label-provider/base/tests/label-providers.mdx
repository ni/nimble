...
For Angular clients, see [Localization section of the nimble-angular readme](https://github.com/ni/nimble/blob/main/packages/angular-workspace/projects/ni/nimble-angular/README.md#localization-optional) for specific usage guidance with Angular.
