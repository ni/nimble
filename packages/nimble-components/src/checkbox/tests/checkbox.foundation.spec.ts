/**
 * Based on tests in FAST repo: https://github.com/microsoft/fast/blob/archives/fast-element-1/packages/web-components/fast-foundation/src/checkbox/checkbox.spec.ts
 */
