...
> {
    ...
    public constructor(requiredUpdates: TrackedProperties) {
        ...
        this.requiredUpdates = requiredUpdates.reduce<RequiredUpdates>(
            (r, key): RequiredUpdates => {
                return {
                    ...r,
                    [key]: false
                };
    ...
    protected setAllKeys(value: boolean): void {
        type RequiredUpdates = typeof this.requiredUpdates;
        this.requiredUpdates = Object.keys(
            this.requiredUpdates
        ).reduce<RequiredUpdates>((r, key): RequiredUpdates => {
            return {
                ...r,
                [key]: value
            };
