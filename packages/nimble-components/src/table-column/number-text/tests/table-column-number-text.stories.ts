...
export const numberTextColumn: StoryObj<TextColumnTableArgs> = {
    ...
    argTypes: {
        ...
        decimalDigits: {
            name: 'decimal-digits',
            description: 'The number of decimal places to format values to when using the column `format` is configured to be `decimal`. When not configured, a default value of `2` is used. The value must be in the range 0 - 20 (inclusive).',
        },
        checkValidity: {
            name: 'checkValidity()',
            description:
