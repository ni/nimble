...
-   Import `FormatNumberTextPipe` from `@ni/nimble-angular/pipes`
-   Use the pipe in your templates (pipe name is `formatNumberText`), or instantiate and use directly in your code
