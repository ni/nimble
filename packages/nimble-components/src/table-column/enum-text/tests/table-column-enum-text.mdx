...
-   Provide a mapping for every expected record value. Because grouping is performed on the record value, non-mapped record values may be grouped unexpectedly and will not have a group label.
