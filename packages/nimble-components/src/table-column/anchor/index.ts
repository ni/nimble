...
const baseName = 'table-column-anchor';
export const tableColumnAnchorTag = `nimble-${baseName}`;
declare global {
...
DesignSystem.getOrCreate().withPrefix('nimble').register(nimbleTableColumnAnchor());
