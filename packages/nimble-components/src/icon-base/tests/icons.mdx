...
Nimble icons can be slotted into other components or used independently. Each icon is available as a custom element. For example, `<nimble-icon-add></nimble-icon-add>`.
