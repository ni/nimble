...
See the [nimble-angular Readme](https://github.com/ni/nimble/blob/main/packages/angular-workspace/projects/ni/nimble-angular/README.md#using-nimble-breadcrumb-with-angulars-routerlink)
