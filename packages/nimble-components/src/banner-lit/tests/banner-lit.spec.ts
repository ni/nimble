...
async function setup(): Promise<Fixture<BannerLit>> {
    return fixture<BannerLit>(html`
        <nimble-banner>
...
describe('Banner', () => {
    ...
    it("should initialize 'severity' to default", () => {
        expect(element.severity).toBe(BannerSeverityLit.default);
    });
