...
import type { FoundationElementTemplate, MenuItem, MenuItemOptions } from '@ni/fast-foundation';
import { MenuItemRole, endSlotTemplate, startSlotTemplate } from '@ni/fast-foundation';
