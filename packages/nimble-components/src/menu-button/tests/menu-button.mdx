...
Learn more about properties and attributes. 

### Events

<Controls of={menuButtonStories.events} />

See the documentation for Menu for information about events on the slotted menu.
