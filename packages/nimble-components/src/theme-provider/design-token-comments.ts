...
export const comments: { readonly [key in TokenName]: string | null } = {
    ...
    switchIndicatorBackgroundDisabledColor: 'Background color for disabled switch indicator',
    switchIndicatorBorderColor: 'Border color for switch indicator',
    switchIndicatorBorderDisabledColor: 'Border color for disabled switch indicator',
    controlHeight:
