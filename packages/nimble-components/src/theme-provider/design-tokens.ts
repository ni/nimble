...
//Color Tokens
export const fillColor = create<string>("fill-color").withDefault((element: HTMLElement)=>{
    return theme.getValueFor(element) === NimbleTheme.light ? White : Black85;
});
...
export const outlineColor = create<string>("outline-color").withDefault((element: HTMLElement)=>{
    return theme.getValueFor(element) === NimbleTheme.light ? Black85 : White;
});
...
//Font Color Tokens
export const fontColor = create<string>("label-font-color").withDefault((element: HTMLElement)=>{
