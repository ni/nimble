...
export const tokenNames: { readonly [key in TokenName]: string } = {
    ...
    bodyEmphasized2Font: 'body-emphasized-2-font',
    bodyEmphasized2FontColor: 'body-emphasized-2-font-color',
    bodyEmphasized2DisabledFontColor: 'body-emphasized-2-disabled-font-color',
    bodyEmphasized2FontFamily: 'body-emphasized-2-font-family',
    bodyEmphasized2FontSize: 'body-emphasized-2-font-size',
    bodyEmphasized2FontWeight: 'body-emphasized-2-font-weight',
    bodyEmphasized2FontLineHeight: 'body-emphasized-2-font-line-height',
    bodyEmphasized2FallbackFontFamily: 'body-emphasized-2-fallback-font-family',
    bodyFont: 'body-font',
