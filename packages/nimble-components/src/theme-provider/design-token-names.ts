...
export const tokenNames: { readonly [key in TokenName]: string } = {
    ...
    tableColumnHeaderFont: 'table-column-header-font',
    tableColumnHeaderFontColor: 'table-column-header-font-color',
    tableColumnHeaderDisabledFontColor: 'table-column-header-disabled-font-color',
    tableColumnHeaderFontFamily: 'table-column-header-font-family',
    tableColumnHeaderFontSize: 'table-column-header-font-size',
    tableColumnHeaderFontWeight: 'table-column-header-font-weight',
    tableColumnHeaderFontLineHeight: 'table-column-header-font-line-height',
    tableColumnHeaderFallbackFontFamily: 'table-column-header-fallback-font-family',
