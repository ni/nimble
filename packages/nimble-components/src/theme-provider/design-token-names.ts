...
export const tokenNames: { readonly [key in TokenName]: string } = {
    ...
    primaryButtonFontColor: 'primary-button-font-color',
    primaryFillActionColor: 'primary-fill-action-color',
    accentButtonBackgroundColor: 'accent-button-background-color',
    accentButtonBlockFontColor: 'accent-button-block-font-color',
    accentButtonOutlineFontColor: 'accent-button-outline-font-color',
    accentButtonOutlineBorderColor: 'accent-button-outline-border-color',
    accentFillActionColor: 'accent-fill-action-color',
