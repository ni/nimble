...
export const tokenNames: { readonly [key in TokenName]: string } = {
    ...
    buttonPrimaryBackgroundColor: 'button-primary-background-color',
    buttonPrimaryFontColor: 'button-primary-font-color',
    buttonPrimaryFillActionColor: 'button-primary-fill-action-color',
    buttonAccentBackgroundColor: 'button-accent-background-color',
    buttonBlockAccentFontColor: 'button-block-accent-font-color',
    buttonOutlineAccentFontColor: 'button-outline-accent-font-color',
    buttonOutlineAccentBorderColor: 'button-outline-accent-border-color',
    buttonAccentFillActionColor: 'button-accent-fill-action-color',
