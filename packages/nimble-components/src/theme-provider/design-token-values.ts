...
import {
    ...
    Information10LightUi,
    Information10DarkUi,
    Information30LightUi,
    Information30DarkUi,
    Information50DarkUi,
    Warning10LightUi,
    Warning10DarkUi,
...
export const tokenValues = {
    ...
    calendarEventBackgroundStatic2Color: createThemeColor(Information10LightUi, Information10DarkUi, Information10DarkUi),
    calendarEventBackgroundHoverStatic2Color: createThemeColor(Information30LightUi, Information30DarkUi, Information30DarkUi),
    calendarEventBorderStatic2Color: createThemeColor(Information100LightUi, Information100DarkUi, Information100DarkUi),
    calendarEventStatic2FontColor: createThemeColor(Information100LightUi, Information50DarkUi, Information50DarkUi),
    calendarEventBackgroundStatic3Color: createThemeColor(Warning10LightUi, Warning10DarkUi, Warning10DarkUi),
    calendarEventBackgroundHoverStatic3Color: createThemeColor(Warning20LightUi, Warning20DarkUi, Warning20DarkUi),
    calendarEventBorderStatic3Color: createThemeColor(Warning100LightUi, Warning100DarkUi, Warning100DarkUi),
    calendarEventBackgroundStatic4Color: createThemeColor(NiTulip10, NiTulipDark10, NiTulipDark10),
    calendarEventBackgroundHoverStatic4Color: createThemeColor(NiTulip20, NiTulipDark20, NiTulipDark20),
    calendarEventBorderStatic4Color: createThemeColor(NiTulip, NiTulip, NiTulip),
    calendarEventBackgroundStatic5Color: createThemeColor(NiSpec10, NiSpecDark10, NiSpecDark10),
    calendarEventBackgroundHoverStatic5Color: createThemeColor(NiSpec20, NiSpecDark20, NiSpecDark20),
    calendarEventBorderStatic5Color: createThemeColor(NiSpecDark1, NiSpecDark1, NiSpecDark1),
    calendarEventBackgroundStatic6Color: createThemeColor(BrownLight10, BrownDark10, BrownDark10),
    calendarEventBackgroundHoverStatic6Color: createThemeColor(BrownLight20, BrownDark20, BrownDark20),
    calendarEventBorderStatic6Color: createThemeColor(BrownLight, BrownDark, BrownDark),
    calendarEventBackgroundStatic7Color: createThemeColor(Black10, Black82, Black82),
    calendarEventBackgroundHoverStatic7Color: createThemeColor(Black15, Black85, Black85),
    calendarEventBorderStatic7Color: hexToRgbaCssThemeColor(createThemeColor(Black91, Black44, Black44), 0.5, 1, 1),
    controlHeight: '32px',
