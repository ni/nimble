...
export const tokenValues = {
    ...
    calendarEventBackgroundStatic2Color: createThemeColor(InformationLight10, InformationDark10, InformationDark10),
    calendarEventBackgroundHoverStatic2Color: createThemeColor(InformationLight30, InformationDark30, InformationDark30),
    calendarEventBorderStatic2Color: createThemeColor(Information100LightUi, Information100DarkUi, Information100DarkUi),
    calendarEventStatic2FontColor: createThemeColor(Information100LightUi, InformationDarkTypography, InformationDarkTypography),
    calendarEventBackgroundStatic3Color: createThemeColor(WarningLight10, WarningDark10, WarningDark10),
    calendarEventBackgroundHoverStatic3Color: createThemeColor(WarningLight20, WarningDark20, WarningDark20),
    ...
    calendarEventBorderStatic5Color: createThemeColor(NiSpec, NiSpec, NiSpec),
    ...
    calendarEventBackgroundStatic7Color: createThemeColor(Black91V10, Black82, Black82),
    calendarEventBackgroundHoverStatic7Color: createThemeColor(Black15, Black85, Black85),
    calendarEventBorderStatic7Color: hexToRgbaCssThemeColor(createThemeColor(Black91, Black82V100, Black82V100), 0.5, 1, 1),
    controlHeight: '32px',
