...
export const tokenValues = {
    ...
    calendarEventBackgroundStatic7Color: createThemeColor(Black9110, Black82, Black82),
    calendarEventBackgroundHoverStatic7Color: createThemeColor(Black15, Black85, Black85),
    calendarEventBorderStatic7Color: hexToRgbaCssThemeColor(createThemeColor(Black91, Black82100, Black82100), 0.5, 1, 1),
    controlHeight: '32px',
