...
We will implement an Angular `ControlValueAccessor` with `RadioControlValueAccessor` as the base class: <https://angular.dev/api/forms/RadioControlValueAccessor>
