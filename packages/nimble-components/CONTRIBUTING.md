...
| tests/component-name-docs.stories.ts   | Contains the Storybook documentation for this component. This should provide design guidance and usage information. See the [CONTRIBUTING-DOCS.md](CONTRIBUTING-DOCS.md) for more information.     |
