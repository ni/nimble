...
describe('NimbleTableColumnDurationText', () => {
    describe('module', () => {
        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [NimbleTableColumnDurationTextModule]
            });
        });

        it('custom element is defined', () => {
            expect(customElements.get('nimble-table-column-duration-text')).not.toBeUndefined();
        });
    });
    ...
    describe('with template string values', () => {
        ...
        class TestHostComponent {
            ...
            @ViewChild('column', { read: ElementRef }) public elementRef: ElementRef<TableColumnDurationText>;
        }

        let fixture: ComponentFixture<TestHostComponent>;
        let directive: NimbleTableColumnDurationTextDirective;
        let nativeElement: TableColumnDurationText;
        beforeEach(() => {
            TestBed.configureTestingModule({
