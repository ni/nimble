...
import { NimbleTableColumnEnumTextDirective, TableColumnEnumText } from '../nimble-table-column-enum-text.directive';
import { TableColumnSortDirection } from '../../nimble-table-column-base.directive';

describe('NimbleTableColumnEnumText', () => {
    describe('module', () => {
        beforeEach(() => {
        ...
        it('custom element is defined', () => {
            expect(customElements.get('nimble-table-column-enum-text')).not.toBeUndefined();
        });
    });
    ...
    describe('with template string values', () => {
        ...
        class TestHostComponent {
            @ViewChild('column', { read: NimbleTableColumnEnumTextDirective }) public directive: NimbleTableColumnEnumTextDirective;
            @ViewChild('column', { read: ElementRef }) public elementRef: ElementRef<TableColumnEnumText>;
        }

        let fixture: ComponentFixture<TestHostComponent>;
        let directive: NimbleTableColumnEnumTextDirective;
        let nativeElement: TableColumnEnumText;
        beforeEach(() => {
            TestBed.configureTestingModule({
