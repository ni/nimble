...
describe('Nimble dialog', () => {
    ...
    describe('with no values in template', () => {
        ...
        it('has expected defaults for role', () => {
            expect(directive.role).toBeNull();
            expect(nativeElement.role).toBeNull();
        });
    ...
    describe('with template string values', () => {
        ...
        it('will use template string values for role', () => {
            expect(directive.role).toBe('role');
            expect(nativeElement.role).toBe('role');
        });
    });
    ...
    describe('with property bound values', () => {
        ...
        it('can be configured with property binding for role', () => {
            expect(directive.role).toBe('role');
            expect(nativeElement.role).toBe('role');

            fixture.componentInstance.role = 'new role';
            fixture.detectChanges();

            expect(directive.role).toBe('new role');
            expect(nativeElement.role).toBe('new role');
        });
    });
    ...
    describe('with attribute bound values', () => {
        ...
        it('can be configured with attribute binding for role', () => {
            expect(directive.role).toBe('role');
            expect(nativeElement.role).toBe('role');
