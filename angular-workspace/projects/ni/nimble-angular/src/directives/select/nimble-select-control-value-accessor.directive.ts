/**
 * Copied from Angular source: https://github.com/angular/angular/blob/master/packages/forms/src/directives/select_control_value_accessor.ts
 *
 * Modified to target Nimble elements, and to use the nimble-listbox-option's value attribute instead of its value property.
 */
...
import {Directive, ElementRef, forwardRef, Host, Input, isDevMode, OnDestroy, Optional, Renderer2, StaticProvider} from '@angular/core';
...
import { NimbleBaseControlValueAccessor } from '../control-value-accessor';
 ...
 export class NimbleSelectOption implements OnDestroy {
   /**
    * @description
   ...
   constructor(
       ...
       @Optional() @Host() private _select: NimbleSelectControlValueAccessor) {
   ...
   _setElementValue(value: string): void {
     this._renderer.setAttribute(this._element.nativeElement, 'value', value);
   }
