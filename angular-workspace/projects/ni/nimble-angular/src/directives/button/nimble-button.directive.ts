...
import type { ButtonAppearanceValue, ButtonType } from '@ni/nimble-components/dist/esm/button/types';
...
export class NimbleButtonDirective {
    ...
    @Input() public set appearance(value: ButtonAppearance | ButtonAppearanceValue) {
