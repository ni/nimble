...
import { RadioControlRegistryModule, RadioControlValueAccessor } from '../radio_control_value_accessor';
  ...
  describe('value accessors', () => {
    function initTest<T>(component: Type<T>, ...directives: Type<any>[]): ComponentFixture<T> {
      TestBed.configureTestingModule(
          {
            // [Nimble] update declarations to add necessary directives
            ...
            // [Nimble] update imports to include RadioControlRegistryModule
            imports: [FormsModule, ReactiveFormsModule, RadioControlRegistryModule]
          });
